...
export function LeafIcon({ className = '', size = 16 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c1.5 0 3-.3 4.2-1" />
      <path d="M12 2c3 2 5 5.5 5 10s-2 8-5 10" />
      <path d="M12 22V12" />
      <path d="M12 12c2-1 4-3 4-6" />
    </svg>
  );
}
...
export function BookmarkIcon({ className = '', size = 20 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M4 4v16l8-6 8 6V4a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2z" />
    </svg>
  );
}
